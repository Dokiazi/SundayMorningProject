...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['OutBox Team'],
			['Dokiazi',		'dokiazi',		'Main Programmer of OutBox Only btw lololol',								'https://twitter.com/Shadow_Mario_',	'444444'],
			[''],
			['Engine Contributors'],
			...
			['your smile copy blabla',		'thebunny',	'i dunno what he did but yeah',							'https://twitter.com/ninja_muffin99',	'WOOOOW'],
			[''],
			["Funkin' Crew"],
