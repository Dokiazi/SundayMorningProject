...
{
	public static var Version:String = 'OoB - 0.1.0'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "0.2.7.1 - " + Version, 12);
